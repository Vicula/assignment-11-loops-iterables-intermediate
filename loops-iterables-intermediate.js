...
var runThrough = function(editStrg) {
    ...
    for (var i = 0; i < editStrg.length; i++) {

    	if (oddNumb === true) {

            bannMan = editStrg.length / 2
        	bannMan = Math.floor(bannMan)

            if (editStrg[i] === bannMan) {
